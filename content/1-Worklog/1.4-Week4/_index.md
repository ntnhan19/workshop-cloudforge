...
| Wed | Study standard data processing flows on AWS environments. | 13/05/2026 | 13/05/2026 | [AWS Well-Architected Framework](https://docs.aws.amazon.com/wellarchitected/latest/framework/welcome.html) |
| Thu | Build basic serverless APIs using Lambda and DynamoDB. | 14/05/2026 | 14/05/2026 | [AWS Serverless Land Patterns](https://serverlessland.com/patterns) |
| Fri | Practice deploying API Gateway to the test environment. | 15/05/2026 | 15/05/2026 | [AWS Serverless Land Patterns](https://serverlessland.com/patterns) |
| Sat | Practice testing serverless APIs using Postman and AWS Console. | 16/05/2026 | 16/05/2026 | [Postman Docs](https://learning.postman.com/docs/getting-started/introduction/) <br> [AWS Console](https://aws.amazon.com/console/) |
| Sun | Hold an online team meeting to finalize plans and prepare for project deployment in week 5. | 17/05/2026 | 17/05/2026 | [AWSStudyGroup YouTube](https://www.youtube.com/@AWSStudyGroup) <br> [CloudJourney](https://cloudjourney.awsstudygroup.com/) |
