...
*Ảnh minh họa: Thêm cấu hình OpenID Connect của GitHub vào AWS IAM.*
![Thiết lập OIDC Provider](/images/5-Workshop/5.12-cicd/5.12.1-oidc-provider.png)
...
*Ảnh minh họa: Cấu hình Trust relationships giới hạn quyền Assume Role cho duy nhất Repository dự án.*
