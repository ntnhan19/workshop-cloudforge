...
**Bước tiếp theo:** Hệ thống đã tự vận hành hoàn hảo, nhưng làm sao để quản trị viên theo dõi được sức khỏe hệ thống và truy vết lỗi nếu có sự cố xảy ra? Ở chương cuối cùng ([**Chương 5.13: Observability**](../../5.13-Observability/)), chúng ta sẽ khám phá cách giám sát toàn diện ứng dụng với AWS CloudWatch và AWS X-Ray.
