...
---
**Bước tiếp theo:** Hệ thống hạ tầng mạng đa tầng (VPC và Subnets) đã được khởi tạo thành công. Chúng ta sẽ tiến tới phần [**Kiểm tra NAT Gateway & Định tuyến**](../5.3.2-create-nat-gateway/) để đảm bảo các dịch vụ nội bộ có thể kết nối ra Internet một cách an toàn thông qua bảng định tuyến (Route Tables).
