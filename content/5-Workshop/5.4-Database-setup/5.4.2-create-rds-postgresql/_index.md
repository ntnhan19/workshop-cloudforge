...
**Next Step:** While waiting for the RDS instance to finish provisioning, we will move to section [**5.4.3**](../5.4.3-enable-pgvector/) to enable the `pgvector` extension, preparing the database to store embeddings.
