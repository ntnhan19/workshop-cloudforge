...
*📸 Ảnh minh họa: Tạo Subnet Group cho Redis*
![Redis Subnet Group](../../../../images/5-Workshop/5.4-Database-setup/5.4.3-create-elasticache-redis/redis_subnet_group.png)
...
*📸 Ảnh minh họa: Thiết lập phần Security groups cho Redis tuân thủ Zero-Trust (Chụp tại Step 2).*
![Redis Connectivity](../../../../images/5-Workshop/5.4-Database-setup/5.4.3-create-elasticache-redis/redis_connectivity.png)
