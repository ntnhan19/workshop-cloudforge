...
**Bước tiếp theo:** Hệ thống dữ liệu lõi đã hoàn tất. Chúng ta sẽ tiến tới phần [**5.4.5**](../5.4.5-test-connection/) để tổng hợp lại các Endpoint cần thiết, chuẩn bị hành trang đưa mã nguồn Backend lên Cloud.
