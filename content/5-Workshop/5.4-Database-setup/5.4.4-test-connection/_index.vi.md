...
Do cụm Redis được cô lập hoàn toàn trong vùng Private Subnet, chúng bắt buộc phải sử dụng máy chủ trung gian EC2 (Bastion Host) nằm trong cùng mạng VPC để thực hiện kiểm thử.
...
Nếu cấu hình mạng hoàn toàn chính xác, Terminal sẽ ngay lập tức phản hồi:
