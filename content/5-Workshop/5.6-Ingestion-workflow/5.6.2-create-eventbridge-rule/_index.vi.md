...
*Ảnh minh họa: Quy tắc định tuyến sự kiện EventBridge được thiết lập thành công thông qua giao diện trực quan.*
![EventBridge Rule Created](../../../../images/5-Workshop/5.6-Ingestion-workflow/5.6.2-eventbridge/eventbridge_rule_created.png)
