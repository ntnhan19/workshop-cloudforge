...
- Access the console interface of the S3 Bucket `cloudforge-media-upload-ntnhan19`.
...
- Access the **AWS Step Functions** service → Select the state machine `cloudforge-media-workflow`.
- Click the **Start execution** button. In the Input dialog, keep the default structure and click **Start execution** again.
