...
*Ảnh minh họa: Mở rộng mục More để thấy thông số Messages available của SQS.*
...
*Ảnh minh họa: Nhập JSON giả lập và kích hoạt State Machine.*
...
*Ảnh minh họa: Màn hình danh sách các lần thực thi (Executions) của State Machine.*
...
*Ảnh minh họa: Chi tiết Payload In/Out của một State trong Step Functions.*
